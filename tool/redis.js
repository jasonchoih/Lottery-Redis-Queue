'use strict';
// 
const { us, lottery, sd28, caomei } = require('../config/config');
//
...
// const client_caomei = redis.createClient(caomei);
// 
// 
// const redis_caomei_subs = redis.createClient(client_caomei);
// 
//
const redis_sd28_pub = promisify(client_sd28.publish).bind(client_sd28); 
// const redis_sd28_lpush = promisify(client_sd28.lpush).bind(client_sd28); // 左加入 redis_lottery_lpush(name, jsp)
// 
